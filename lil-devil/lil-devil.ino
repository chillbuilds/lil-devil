...
void setup() {
  ...
  poopPositions[0] = getRandomNumber(4, 10);
  poopPositions[1] = getRandomNumber(22, 28);
  poopPositions[2] = getRandomNumber(40, 48);
  poopPositions[3] = getRandomNumber(86, 95);
  poopPositions[4] = getRandomNumber(86, 95);
  poopPositions[5] = getRandomNumber(86, 95);
...
void loop() {
  ...
  if (currentMillis - previouspooLvlMillis >= pooLvlInterval) {
    ...
    if (pooLvl >= 5) {
      ...
      pooLvl = 0;
      if(poopTotal < 3){
        Serial.print("poop total: ");
        Serial.println(poopTotal);
        poopTotal++;
      }
    }
  }
...
void drawIcons() {
  ...
  display.drawBitmap(6, 110,  stats_icon, 12, 12, 1);
  display.drawBitmap(45, 110,  clock_icon, 12, 12, 1);

  if(poopTotal > 0){
    display.drawBitmap(poopPositions[0], poopPositions[3],  poop_1, 12, 12, 1); 
  }
  if(poopTotal > 1){
    display.drawBitmap(poopPositions[1], poopPositions[4],  poop_1, 12, 12, 1); 
  }
  if(poopTotal > 2){
